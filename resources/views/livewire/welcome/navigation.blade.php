<div class="sm:fixed sm:top-0 sm:right-0 p-6 text-end z-10">
    ...
    @else
        ...
        @if (Route::has('testingvolt'))
            <a href="{{ route('testingvolt') }}" class="ms-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500" wire:navigate>testingvolt</a>
        @endif
    @endauth
</div>
